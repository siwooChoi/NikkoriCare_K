...
// 사이드메뉴 슬라이드
  ...
  function tObservation(childID, imageName, childName){
              ...
              success:function(data){
                  ...
                  if(data.result == "success"){
                      ...
                      for(var i = 0; i < cnt ; i++){
                          ...
                          var imgs = $("<img />").addClass("imageNameObs imageNameObs"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
      ...
      $("#tObChangeModeBtn").unbind("click").bind("click", function(){
        ...
        // makeChangePanel(argValues);
          ...
          var changeBtn1Text = $("<p>원아 메모 작성</p>").appendTo(changeBtn1);
          ...
          var changeBtn2Text = $("<p>수업 평가항목</p>").appendTo(changeBtn2);
          $(".changeBtn2").unbind("click").bind("click", function(){
              allHide();
              var newDate = new Date();
              var dateValue = newDate.getFullYear() + "-" + (newDate.getMonth() + 1) + "-" + newDate.getDate();
          ...
          var changeBtn3Text = $("<p>I-Check</p>").appendTo(changeBtn3);
          $(".changeBtn3").unbind("click").bind("click", function(){
              allHide();
              var newDate = new Date();
              var dateValue = newDate.getFullYear() + "-" + (newDate.getMonth() + 1) + "-" + newDate.getDate();
          ...
          var changeBtn4Text = $("<p>사진 업로드</p>").appendTo(changeBtn4);
          ...
          var changeBtn5Text = $("<p>앨범 보기</p>").appendTo(changeBtn5);
            ...
            success:function(data){
                ...
                if(data.result == "success"){
                    ...
                    for(var i = 0; i < cnt ; i++){
                        ...
                        var imgs = $("<img />").addClass("imageNameDev imageNameDev"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
                        ...
                        $(".selectImgAndNameDev"+childID).unbind("click").bind("click",function(){
                            ...
                            //     var btnText = $("<p></p>").text('상태체크 항목 보기');
                            ...
                            //     var btnText = $("<p></p>").text('발달체크 항목 보기');
    ...
    function drawDevelopCheck(childID, imageName, childName, dateValue){
      ...
      // 선택한 원아 이름, 이미지 출력
        ...
        $.ajax({
          ...
          url:"http://project-okyo.c9users.io/mobile/getBasicChecks.php",
          success:function(data){
            if(data.result == "success"){
  ...
  function tICheck(childID, imageName, childName, dateValue){
                 ...
                 success:function(data){
                     ...
                     if(data.result == "success"){
                         ...
                         for(var i = 0; i < cnt ; i++){
                             ...
                             var imgs = $("<img />").addClass("imageNameICh imageNameICh"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
    ...
    function notification(ReDateValue, reChildID){
      ...
      $(".notification_showAddAlbumBtn").unbind("click").bind("click", function(){
        ...
        $.ajax({
          ...
          url:'http://project-okyo.c9users.io/mobile/viewPhoto.php',
          success:function(data){
            ...
            for(var i = 0; i < cnt ; i++){
              ...
              var photoMemo = data.data[i].photoMemo;
                ...
                var imgs    = $("<img />").attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+photoName).addClass("addAlbumID"+photoId);
                // var imgsDiv = $("<div></div>").addClass("uploadedImgDiv").append(imags);
                ...
                (function(photoId, childId, photoName, i){
                  ...
                  $(".AddAlbum"+photoId).unbind("click").bind("click",function(){
                    ...
                    //   alert('사진추가는 한장만.');
                    // } else{
                    var img = $("<img />").attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+photoName).attr("value", photoName).addClass("notification_imageDiv2Img notification_imageDiv2Img"+i);
                        ...
                        if(flag == "go"){
                          // alert('모두 통과, 업로드 Yes');
                            ...
                            $(".notification_imageDiv2").children().unbind("click").bind("click", function(){
                              ...
                              // alert(value);
                              // 사진클릭 시 제거
                              var YesOrNo = confirm("등록을 취소하시겠습니까?");
        ...
        success:function(data){
          ...
          // 알림장 내용은 없는데, 사진은 있음
                  ...
                  for(var i = 0; i < cnt2; i++){
                    // 알림장보기 사진들어갈 공간
                    $("<div></div>").addClass("notification_imageDiv1").appendTo(".notification_div");
                    var img = $("<img />").attr("value", data.data2[i].photoName).attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+data.data2[i].photoName).addClass("notification_imageDiv1Img notification_imageDiv1Img_"+i);
          ...
          // 알림장 내용, 사진 둘다 있음
                ...
                for(var i = 0; i < cnt2; i++){
                  ...
                  // var img = $("<img />").attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+data.data2[i].photoName).addClass("notification_imageDiv1Img notification_imageDiv1Img_"+i);
                  $("<div></div>").addClass("notification_imageDiv1").appendTo(".notification_div");
                  var img = $("<img />").attr("value", data.data2[i].photoName).attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+data.data2[i].photoName).addClass("notification_imageDiv1Img notification_imageDiv1Img_"+i);
                  $(".notification_imageDiv1").append(img);
                }
      ...
      $("<p>취소</p>").appendTo(".notification_cancelBtn");
    ...
    function developGraph(dateValue, reChildID){
      ...
      $("<p></p>").text('수업 평가항목').appendTo(".developGraph_div1").addClass("developGraphTitleText");
      ...
      $.ajax({
        ...
        url:"http://project-okyo.c9users.io/mobile/getAssessed.php",
        success:function(data){
          ...
          $("<p></p>").text('평').appendTo(valueGraphDiv1Btn);
          $("<p></p>").text('가').appendTo(valueGraphDiv1Btn);
          $("<p></p>").text('그').appendTo(valueGraphDiv1Btn);
          $("<p></p>").text('래').appendTo(valueGraphDiv1Btn);
          $("<p></p>").text('프').appendTo(valueGraphDiv1Btn);
          ...
          $(".valueGraphDiv1Btn").unbind("click").bind("click", function(){
            ...
            $(".developGraphTitleText").text('수업 평가항목');
          });

          // 상태그래프 보기 버튼
          var valueGraphDiv2Btn = $("<div></div>").addClass("valueGraphDiv2Btn").appendTo("#modeContents");
          $("<p></p>").text('상').appendTo(valueGraphDiv2Btn);
          $("<p></p>").text('태').appendTo(valueGraphDiv2Btn);
          $("<p></p>").text('그').appendTo(valueGraphDiv2Btn);
          $("<p></p>").text('래').appendTo(valueGraphDiv2Btn);
          $("<p></p>").text('프').appendTo(valueGraphDiv2Btn);
          ...
          $(".valueGraphDiv2Btn").unbind("click").bind("click", function(){
            ...
            $(".developGraphTitleText").text('상태 그래프');
          });
          ...
          function valueGraphDiv1Open(){
            ...
            var valueGraphDiv1 = $("<div></div>").addClass("valueGraphDiv1").appendTo(".developGraph_div2");
              if(cnt1 > 0){
                ...
                var noCheckMessage = $("<div></div>").text('오늘은 아직 체크하지 않았습니다.');
  ...
  // i-Care (구 원아지킴이)
     function iCare(){        // js, css 다하면 주석 풀어야됨
        ...
        //
        //
        //       var modeText = $("<p></p>").text('실외 모드 GPS').addClass('out');
        ...
        //     });
        //
        //     var modeText = $("<p></p>").text('실내 모드 Beacon').addClass('in');
        //     $("#modeMessage2").append(modeText);
        //     $("#alarm_range_GPS").hide();
        //     $("#alarm_range_BLE").show();
        //     // 실내 모드 일때 동작할 것들
                  ...
                  success:function(data){
                      ...
                      if(data.result == "success"){
                          ...
                          for(var i = 0; i < cnt ; i++){
                              ...
                              var imgs = $("<img />").addClass("imageNamePhoto imageNamePhoto"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
    ...
    function showAlbum(childID, imageName, childName, optionValue){
                  ...
                  success:function(data){
                      ...
                      if(data.result == "success"){
                          ...
                          for(var i = 0; i < cnt ; i++){
                              ...
                              var imgs = $("<img />").addClass("imageNameAlbum imageNameAlbum"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
      ...
      // 현재 선택된 원아 사진 이름 띄우기
      var imgs = $("<img />").addClass("tAlbum_ImageName").attr("src","http://project-okyo.c9users.io/img/child/"+imageName);
  ...
  /*
      ...
      */
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            for(var i = 0; i < cnt; i++){
              ...
              var imgs    = $("<img />").attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+photoName).addClass("photo"+photoId);
              // var memos   = $("<p></p>").text(photoMemo);
              var imgsDiv = $("<div></div>").addClass("photoImgsDiv").append(imgs);
              $("#showAlbumDiv").append(imgsDiv);
      ...
      function detailPhotoView(photoId, photoName, registDay, photoMemo, optionValue){
        ...
        var img  = $("<img />").attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+photoName);
    ...
    $("#box6").unbind("click").bind("click", function(){
          ...
          success:function(data){
              ...
              if(data.result == "success"){
                  ...
                  for(var i = 0; i < cnt ; i++){
                      ...
                      var imgs = $("<img />").addClass("atd_childImage"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
      ...
      //////////////////// 원아 이미지 및 이름 출력 ajax끝부분
        ...
        function attendanceBtns(childIdArray, cnt){
          $.ajax({
            url:"http://project-okyo.c9users.io/mobile/getAttendanceCheckT.php",
            data:{
                ...
                (function(childID){
                  ...
                  $("#allCheckBtn").unbind("click").bind("click", function(){
                    ...
                    $("#tAttendanceSaveBtn").unbind("click").bind("click", function(){
                      ...
                      $.ajax({
                        url:"http://project-okyo.c9users.io/mobile/setAttendanceCheckT.php",
                        data:{
    ...
    // 발달체크 항목편집 클릭
      ...
      function pICheck(childID, imageName, childName, dateValue){
        ...
        //                          var imageComment = data.data[i].imageComment;
        //
        //                          var imgs = $("<img />").addClass("imageNamePiCh imageNamePiCh"+childID).attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
        ...
        function pNotification(ReDateValue, reChildID){
          ...
          $("<p>댓</p>").appendTo(pShowCommentsBtn);
          $("<p>글</p>").appendTo(pShowCommentsBtn);
          $("<p>보</p>").appendTo(pShowCommentsBtn);
          $("<p>기</p>").appendTo(pShowCommentsBtn);
          ...
          $("<p></p>").text("작성").appendTo(".pUploadComment_div");
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              // 알림장 내용은 없는데, 사진은 있음
                      ...
                      for(var i = 0; i < cnt2; i++){
                        // 알림장보기 사진들어갈 공간
                        var img = $("<img />").attr("src", "http://project-okyo.c9users.io/img/album/childID_"+childID+"/"+data.data2[i].photoName).addClass("pNotification_imageDiv1Img pNotification_imageDiv1Img_"+i);
        ...
        function pDevelopGraph(dateValue, reChildID){
          ...
          $("<p></p>").text('수업 평가항목').appendTo(".pDevelopGraph_div1").addClass("pDevelopGraphTitleText");
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              $("<p></p>").text('평').appendTo(pValueGraphDiv1Btn);
              $("<p></p>").text('가').appendTo(pValueGraphDiv1Btn);
              $("<p></p>").text('그').appendTo(pValueGraphDiv1Btn);
              $("<p></p>").text('래').appendTo(pValueGraphDiv1Btn);
              $("<p></p>").text('프').appendTo(pValueGraphDiv1Btn);
              ...
              $(".pValueGraphDiv1Btn").unbind("click").bind("click", function(){
                ...
                $(".pDevelopGraphTitleText").text('수업 평가항목');
              });

              // 상태그래프 보기 버튼
              var pValueGraphDiv2Btn = $("<div></div>").addClass("pValueGraphDiv2Btn").appendTo("#pModeContents");
              $("<p></p>").text('상').appendTo(pValueGraphDiv2Btn);
              $("<p></p>").text('태').appendTo(pValueGraphDiv2Btn);
              $("<p></p>").text('그').appendTo(pValueGraphDiv2Btn);
              $("<p></p>").text('래').appendTo(pValueGraphDiv2Btn);
              $("<p></p>").text('프').appendTo(pValueGraphDiv2Btn);
              ...
              $(".pValueGraphDiv2Btn").unbind("click").bind("click", function(){
                ...
                $(".pDevelopGraphTitleText").text('상태 그래프');
              });
              ...
              success:function(data){
                ...
                for(var i = 0; i < cnt; i++){
                  ...
                  if(data.data[i].position == 2){
                    ...
                    $("<div></div>").addClass("teacherTrue1").text("교사").appendTo(pTeacherCommentBox);
                  ...
                  // 댓글 입력한 것이 교사가 아니라면.
                    ...
                    $("<div></div>").addClass("teacherTrue0").text("학부모").appendTo(pParentCommentBox);
      ...
      function pAttendanceCheck(childID, imageName, childName){
        ...
        $.ajax({
            ...
            success:function(data){
              ...
              var imageComment = data.data[0].imageComment;
                    ...
                    var imgs = $("<img />").addClass("pAtd_childImage").attr("src", "http://project-okyo.c9users.io/img/child/"+imageName);
        ...
        function attendanceBtns(dateValue){
          $.ajax({
            url:"http://project-okyo.c9users.io/mobile/getAttendanceCheckP.php",
            data:{
              childID: childID,
              dateValue: dateValue
            },
                ...
                $("#pAttSaveBtn").unbind("click").bind("click", function(){
                   ...
                   var comment = $("#pAttText").val();
                    ...
                    if(comment == ""){
                      ...
                      $.ajax({
                        url:"http://project-okyo.c9users.io/mobile/setAttendanceCheckP.php",
                        data:{
                          childID: childID,
                          uploader: 3,
                          comment : comment,
